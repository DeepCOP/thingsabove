...
const TabIcon = ({focused, icon,title}: {focused: boolean, icon: any,title:string}) => {
    ...
    return (
            <View className='flex w-full flex-1 min-w-[80px] min-h-16 mt-4 justify-center items-center overflow-hidden'>
                ...
                <Text className='black text-xs font-[400] text-[#383838FF] font-open-sans-regular'>{title}</Text>
    ...
    <Tabs screenOptions={{
        ...
        <Tabs.Screen name='index' options={{
            ...
            tabBarIcon: (({focused,color,size})=>{
                return (
                    <TabIcon focused={focused} icon={icons.home} title='Feed'/>
        ...
        <Tabs.Screen name='Bible' options={{
            ...
            tabBarIcon: (({focused,color,size})=>{
                return (
                    <TabIcon focused={focused} icon={icons.book} title='Bible' />
            ...
            tabBarIcon: (({focused,color,size})=>{
                return (
                    <TabIcon focused={focused} icon={icons.circlePlus} title='Create'/>
