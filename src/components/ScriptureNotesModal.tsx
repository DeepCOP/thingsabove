...
export default function ScriptureNotesModal({
  visible,
  onClose,
  verse,
  book,
  ...
  }, [visible, verse?.number, book, chapter]);
      ...
      <View className="flex-1 bg-white dark:bg-black" style={{ paddingTop: insets.top + 4 }}>
        ...
        {verse ? (
          <>
            ...
            <Text className="px-4 mt-3 text-sm text-gray-600 dark:text-gray-300">
              {activeScope?.helper ?? 'Join the conversation at different levels of this passage.'}
            </Text>

            <ScrollView className="flex-1 mt-2 px-4" contentContainerStyle={{ paddingBottom: 160 }}>
              <View className="mb-3 p-3 rounded-xl border border-gray-200 dark:border-neutral-700 bg-gray-50 dark:bg-neutral-900">
                  ...
                  <View
                    ...
                    <View className="mt-3 flex-row items-center gap-4">
                      ...
                      <TouchableOpacity
                        ...
                        />
                        <Text className="ml-1 text-sm text-gray-500 dark:text-gray-300">Reply</Text>
                      </TouchableOpacity>
                    </View>
